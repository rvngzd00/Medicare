    ...
    groups: [
      ...
      },
      {
        ...
        fields: [
          ...
          { name: "technologies", label: "Texnologiya və avadanlıqlar", type: "tags", placeholder: "Avadanlıq adı yazıb Enter basın", width: "half" },
...
export const contentSections = [
  ...
  { id: "leadership", title: "Rəhbərlik", description: "Rəhbər heyətin profilləri və müraciətləri", icon: "doctors", items: 4, updated: "14 iyul", status: "Aktiv" },
  { id: "gallery", title: "Qalereya", description: "Xəstəxana, avadanlıq və tədbir şəkilləri", icon: "image", items: 42, updated: "12 iyul", status: "Aktiv" },
...
export const contentEditorMeta = {
  ...
  leadership: { title: "Rəhbərlik", description: "Rəhbər heyətin profillərini idarə edin." },
